...
function showProductRecomendation(id) {
    ...
    recomendation[id].map(item => {
        recomendationHTML += showProductRecomendationProduct(item)
        return item
    })
...
function showProductRecomendationProduct(item) {
    return `
            ...
            <div class="product-item">
                ...
                <div class="pi-text">
                    ...
                    <div class="product-price">
                        ${item.price}
                        <span>${(item.price * 10).toFixed(2)}</span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="pd-desc">
    ...
    <h4>${item.price} <span>${(item.price * 10).toFixed(2)}</span></h4>
</div>
<div class="pd-color">
    <h6>Color</h6>
